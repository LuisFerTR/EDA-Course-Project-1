# Exploratory Data Analysis - Course Porject 1
...
## Objective
The goal of this assignment is reproduce the figures stored in [assignment repostitory](https://github.com/rdpeng/ExData_Plotting1) and create the respective r code for each one considering the dataset is in the same folder.
